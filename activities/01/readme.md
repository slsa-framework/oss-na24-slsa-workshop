...
The repository contains a GitHub workflow [.github/workflow/build-echo-server.yml] which builds and generate provenance for a hypothetical server. The file contains the following steps:
